...
import { ImageModal } from 'components/Module3/ImageModal/ImageModal';
import {
  CardWrapper,
  Image,
  Label,
  ActionButton,
  Actions,
} from 'components/Module3/Sticker/Sticker.styled';
  ...
  render() {
    ...
    return (
      <>
        ...
        <ImageModal isOpen={isImageModalOpen} img={img} onClose={this.toggleImageModal} />
      </>
    );
  }
}
